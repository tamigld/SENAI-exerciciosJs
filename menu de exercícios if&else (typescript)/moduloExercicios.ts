...
export function exercicio1(){
    let user:string = prompt("Digite seu nome de usuário: ")
    let password:string = prompt("Digite sua senha: ")
...
export function exercicio2(){
    let num:number = parseInt(prompt("Digite um número entre 1 e 7: "))
...
export function exercicio4(){
    let anoNasc:number = parseInt(prompt("Digite seu ano de nascimento: "))
...
export function exercicio5(){
    let valor:number = parseFloat(prompt("Digite o valor total da compra do cliente: R$"))
...
export function exercicio6(){
    let peso:number = parseFloat(prompt("Digite seu peso (kg): "))
